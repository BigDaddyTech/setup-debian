...
apt install -y gnome-shell gnome-terminal curl fastfetch gnome-disk-utility evince eog totem mangohud tree gnome-calculator gnome-software wine git arduino
