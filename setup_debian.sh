...
apt install gnome-shell gnome-terminal curl fastfetch gnome-disk-utility mangohud tree gnome-calculator git

# Cleanup bloat from gnome-shell
apt remove malcontent yelp nm-connection-editor im-config
